...
use crate::session::scheduler::Action;
use crate::utils::kv_cache::KvCache;
use crate::utils::token_output_stream::TokenOutputStream;
// use crate::utils::kv_cache::KvCache;
// use crate::utils::token_output_stream::TokenOutputStream;
use super::scheduler::Scheduler;
use super::scheduler::RunConfig;
...
impl Session {
    pub fn new<M: Model>(model: M) -> Session {
        ...
        Self { action_sender, settings }
    }

    pub fn generate(&mut self, prompt: &str) -> Generation<'_> {
        ...
        self.action_sender.send(Action::Run(run_config)).unwrap();
        Generation::new(&(), receiver)
    }
}
